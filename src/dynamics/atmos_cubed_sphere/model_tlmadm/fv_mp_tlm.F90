...
interface mpp_update_domains_tlm
    ...
    module procedure mpp_update_domain2d_5d_tlm_r4
    module procedure mpp_update_domain2d_2dv_tlm_r4
    ...
    module procedure mpp_update_domain2d_5d_tlm_r8
    module procedure mpp_update_domain2d_2dv_tlm_r8
    module procedure mpp_update_domain2d_3dv_tlm_r8
    module procedure mpp_update_domain2d_4dv_tlm_r8
    module procedure mpp_update_domain2d_5dv_tlm_r8
end interface
...
subroutine mpp_update_domain2d_2d_tlm_r4(array, array_tl, domain, flags, complete, position, &
  ...
  real(4), dimension(:,:), intent(inout) :: array, array_tl
  type(domain2d), intent(inout) :: domain
  integer,          intent(in), optional :: flags
...
end subroutine mpp_update_domain2d_2d_tlm_r4

subroutine mpp_update_domain2d_3d_tlm_r4(array, array_tl, domain, flags, complete, position, &
                                                       whalo, ehalo, shalo, nhalo, name, tile_count)
...
end subroutine mpp_update_domain2d_3d_tlm_r4

subroutine mpp_update_domain2d_4d_tlm_r4(array, array_tl, domain, flags, complete, position, &
                                                       whalo, ehalo, shalo, nhalo, name, tile_count)
...
end subroutine mpp_update_domain2d_4d_tlm_r4

subroutine mpp_update_domain2d_5d_tlm_r4(array, array_tl, domain, flags, complete, position, &
                                                       whalo, ehalo, shalo, nhalo, name, tile_count)
...
end subroutine mpp_update_domain2d_5d_tlm_r4

subroutine mpp_update_domain2d_2dv_tlm_r4( u_cmpt, u_cmpt_tl, v_cmpt, v_cmpt_tl, domain, flags, gridtype, complete, &
                                        whalo, ehalo, shalo, nhalo, name, tile_count )

  real(4), dimension(:,:), intent(inout) :: u_cmpt, v_cmpt, u_cmpt_tl, v_cmpt_tl
  type(domain2d), intent(inout) :: domain
...
end subroutine mpp_update_domain2d_2dv_tlm_r4

subroutine mpp_update_domain2d_3dv_tlm_r4( u_cmpt, u_cmpt_tl, v_cmpt, v_cmpt_tl, domain, flags, gridtype, complete, &
                                        whalo, ehalo, shalo, nhalo, name, tile_count )
...
end subroutine mpp_update_domain2d_3dv_tlm_r4

subroutine mpp_update_domain2d_4dv_tlm_r4( u_cmpt, u_cmpt_tl, v_cmpt, v_cmpt_tl, domain, flags, gridtype, complete, &
                                        whalo, ehalo, shalo, nhalo, name, tile_count )
...
end subroutine mpp_update_domain2d_4dv_tlm_r4

subroutine mpp_update_domain2d_5dv_tlm_r4( u_cmpt, u_cmpt_tl, v_cmpt, v_cmpt_tl, domain, flags, gridtype, complete, &
                                        whalo, ehalo, shalo, nhalo, name, tile_count )
...
subroutine mpp_update_domain2d_2d_tlm_r8(array, array_tl, domain, flags, complete, position, &
  ...
  real(8), dimension(:,:), intent(inout) :: array, array_tl
  type(domain2d), intent(inout) :: domain
  integer,          intent(in), optional :: flags
  logical,          intent(in), optional :: complete
  integer,          intent(in), optional :: position
...
end subroutine mpp_update_domain2d_2d_tlm_r8

subroutine mpp_update_domain2d_3d_tlm_r8(array, array_tl, domain, flags, complete, position, &
                                                       whalo, ehalo, shalo, nhalo, name, tile_count)
...
end subroutine mpp_update_domain2d_3d_tlm_r8

subroutine mpp_update_domain2d_4d_tlm_r8(array, array_tl, domain, flags, complete, position, &
                                                       whalo, ehalo, shalo, nhalo, name, tile_count)
...
end subroutine mpp_update_domain2d_4d_tlm_r8

subroutine mpp_update_domain2d_5d_tlm_r8(array, array_tl, domain, flags, complete, position, &
                                                       whalo, ehalo, shalo, nhalo, name, tile_count)
...
end subroutine mpp_update_domain2d_5d_tlm_r8

subroutine mpp_update_domain2d_2dv_tlm_r8( u_cmpt, u_cmpt_tl, v_cmpt, v_cmpt_tl, domain, flags, gridtype, complete, &
                                        whalo, ehalo, shalo, nhalo, name, tile_count )

  real(8), dimension(:,:), intent(inout) :: u_cmpt, v_cmpt, u_cmpt_tl, v_cmpt_tl
  type(domain2d), intent(inout) :: domain
  integer,          intent(in), optional :: flags, gridtype
  logical,          intent(in), optional :: complete
  integer,          intent(in), optional :: whalo, ehalo, shalo, nhalo
...
end subroutine mpp_update_domain2d_2dv_tlm_r8

subroutine mpp_update_domain2d_3dv_tlm_r8( u_cmpt, u_cmpt_tl, v_cmpt, v_cmpt_tl, domain, flags, gridtype, complete, &
                                        whalo, ehalo, shalo, nhalo, name, tile_count )
...
end subroutine mpp_update_domain2d_3dv_tlm_r8

subroutine mpp_update_domain2d_4dv_tlm_r8( u_cmpt, u_cmpt_tl, v_cmpt, v_cmpt_tl, domain, flags, gridtype, complete, &
                                        whalo, ehalo, shalo, nhalo, name, tile_count )
...
end subroutine mpp_update_domain2d_4dv_tlm_r8

subroutine mpp_update_domain2d_5dv_tlm_r8( u_cmpt, u_cmpt_tl, v_cmpt, v_cmpt_tl, domain, flags, gridtype, complete, &
                                        whalo, ehalo, shalo, nhalo, name, tile_count )
...
end subroutine mpp_update_domain2d_5dv_tlm_r8
