...
character(len=128), parameter :: version = '$Id: fv_climate_nudge.F90,v 1.3 2018/03/15 14:19:48 drholdaw Exp $'
character(len=128), parameter :: tagname = '$Name: drh-GEOSadas-5_19_0_newadj-dev $'
